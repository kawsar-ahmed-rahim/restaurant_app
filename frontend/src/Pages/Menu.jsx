          ...
          <div className="max-w-2xl mx-auto">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-12 pr-12 py-4 rounded-full border-2 border-gray-200 focus:border-yellow-500 focus:outline-none transition-colors duration-300 text-gray-700 placeholder-gray-4 shadow-md"
              />
              {searchQuery && (
                <button
